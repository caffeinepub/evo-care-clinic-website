...
export class Backend implements backendInterface {
    ...
    async addRegionalClinicInfo(arg0: string, arg1: Array<string>, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRegionalClinicInfo(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async bookAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getAllRegionalClinicInfos(): Promise<Array<RegionalClinicInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRegionalClinicInfos();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAppointmentRequest(arg0: string): Promise<AppointmentRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppointmentRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRegionalClinicInfo(arg0: string): Promise<RegionalClinicInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getRegionalClinicInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
